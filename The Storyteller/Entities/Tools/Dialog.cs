...
namespace The_Storyteller.Entities.Tools
{
    ...
    internal class Dialog
    {
        ...
        {
            if (!text.TryGetValue(resourceName, out string result))
            {
        ...
        {
            if (mCase is DesertCase)
            {
                result = result.Replace("$CASE_TYPE", "desert");
            }
            else if (mCase is MountainCase)
            {
                result = result.Replace("$CASE_TYPE", "mountainous");
            }
            else if (mCase is LandCase)
            {
                result = result.Replace("$CASE_TYPE", "land");
            }
            else if (mCase is ForestCase)
            {
                result = result.Replace("$CASE_TYPE", "forest");
            }
            else if (mCase is WaterCase)
            {
                result = result.Replace("$CASE_TYPE", "aquatic");
            }
            else
            {
                result.Replace("$CASE_TYPE", "unknown");
            }
